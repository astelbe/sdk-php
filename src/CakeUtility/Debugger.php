...
class Debugger {
	...
	public static function checkSecurityKeys() {
		if (Configure::read('Security.salt') === 'DYhG93b0qyJfIxfs2guVoUubWwvniR2G0FgaC9mi') {
			trigger_error('Please change the value of %s in %s to a salt value specific to your application.', '\'Security.salt\'', CONFIG . 'core.php', E_USER_NOTICE);
		}
		
		if (Configure::read('Security.cipherSeed') === '76859309657453542496749683645') {
			trigger_error('Please change the value of %s in %s to a numeric (digits only) seed value specific to your application.', '\'Security.cipherSeed\'', CONFIG . 'core.php', E_USER_NOTICE);
		}
	}
