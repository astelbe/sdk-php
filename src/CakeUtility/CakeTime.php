...
class CakeTime {
	 ...
	 * ```
	 *
	 * @param int|string|DateTime $date UNIX timestamp, strtotime() valid string or DateTime object (or a date format
	 *     string)
	 * @param int|string|DateTime $format date format string (or UNIX timestamp, strtotime() valid string or DateTime
	 *     object)
	 * @param bool|string         $default if an invalid date is passed it will output supplied default value. Pass
	 *     false if you want raw conversion value
	 * @param string|DateTimeZone $timezone Timezone string or DateTimeZone object
	 *
	 * @return string Formatted date string
	 ...
	 *    This option is only used when $filter is set to DateTimeZone::PER_COUNTRY (available only in PHP 5.3 and
	 *     above)
