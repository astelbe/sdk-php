...
class Validation {
	 ...
	 * @param string|array $type 'all' may be passed as a sting, defaults to fast which checks format of most major
	 *     credit cards if an array is used only the values of the array are checked. Example: array('amex',
	 *     'bankcard', 'maestro')
	 * @param bool         $deep set to true this will check the Luhn algorithm of the credit card.
	 * @param string       $regex A custom regex can also be passed, this will be used instead of the defined regex
	 *     values
	 *
	 * @return bool Success
	 * @see Validation::luhn()
	 ...
	 * @param string       $regex Regex for the date part. If a custom regular expression is used this is the only
