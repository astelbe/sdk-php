...
class Set {
	 ...
	 * to the two is that if an array key contains another array then the function behaves recursive (unlike
	 ...
	 * - /Post/Comment[author_name=john]/../name (Selects the name of all Posts that have at least one Comment written
	 * by john)
	 ...
	 *
	 * @return mixed An array of matched items or the content of a single selected item or null in any of these cases:
	 *     $path or $data are null, no items found.
